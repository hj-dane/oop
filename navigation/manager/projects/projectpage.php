...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <a href="../projects/projectpage.php" class="link-active mb-2 mt-1"><i class="fas fa-folder me-2"></i> <span>Manage Project</span></a>
          ...
          <form id="projectForm">
            ...
            <div class="row g-3 mb-3">
              ...
              <div class="col-md-4">
                ...
                <select class="form-select" name="status" id="pStatus" required>
  ...
  <script>
    ...
    $('#archiveProjectBtn').on('click', function () {
      ...
      Swal.fire({
        ...
        text: "This will set the status to Archived.",
        icon: 'warning',
